            ...
            var malzemeler = new[]
{
    ...
    new { MalzemeAdi = "Kabak", ToplamMiktar = 120, MalzemeBirim = "Kilogram", BirimFiyat = 5.00m },
    new { MalzemeAdi = "Havuç", ToplamMiktar = 160, MalzemeBirim = "Kilogram", BirimFiyat = 3.00m },
    new { MalzemeAdi = "Pırasa", ToplamMiktar = 100, MalzemeBirim = "Kilogram", BirimFiyat = 4.25m },
    new { MalzemeAdi = "Brokoli", ToplamMiktar = 50, MalzemeBirim = "Kilogram", BirimFiyat = 6.00m },
    new { MalzemeAdi = "Lahana", ToplamMiktar = 70, MalzemeBirim = "Kilogram", BirimFiyat = 5.50m },
    new { MalzemeAdi = "Karnabahar", ToplamMiktar = 80, MalzemeBirim = "Kilogram", BirimFiyat = 5.75m },
    new { MalzemeAdi = "Bezelye", ToplamMiktar = 90, MalzemeBirim = "Kilogram", BirimFiyat = 6.50m },
    new { MalzemeAdi = "Ispanak", ToplamMiktar = 120, MalzemeBirim = "Kilogram", BirimFiyat = 4.75m },
    new { MalzemeAdi = "Kırmızı Lahana", ToplamMiktar = 60, MalzemeBirim = "Kilogram", BirimFiyat = 5.25m },
    new { MalzemeAdi = "Bal Kabağı", ToplamMiktar = 40, MalzemeBirim = "Kilogram", BirimFiyat = 3.50m },
    new { MalzemeAdi = "Nar", ToplamMiktar = 75, MalzemeBirim = "Kilogram", BirimFiyat = 8.50m },
    new { MalzemeAdi = "Kayısı", ToplamMiktar = 55, MalzemeBirim = "Kilogram", BirimFiyat = 15.00m },
    new { MalzemeAdi = "Şeftali", ToplamMiktar = 90, MalzemeBirim = "Kilogram", BirimFiyat = 12.75m },
    new { MalzemeAdi = "Çilek", ToplamMiktar = 45, MalzemeBirim = "Kilogram", BirimFiyat = 14.00m },
    new { MalzemeAdi = "Üzüm", ToplamMiktar = 60, MalzemeBirim = "Kilogram", BirimFiyat = 8.25m },
    new { MalzemeAdi = "Kiraz", ToplamMiktar = 35, MalzemeBirim = "Kilogram", BirimFiyat = 16.00m },
    new { MalzemeAdi = "Ahududu", ToplamMiktar = 20, MalzemeBirim = "Kilogram", BirimFiyat = 25.00m },
    new { MalzemeAdi = "Kestane", ToplamMiktar = 50, MalzemeBirim = "Kilogram", BirimFiyat = 18.00m },
    new { MalzemeAdi = "Mantar", ToplamMiktar = 60, MalzemeBirim = "Kilogram", BirimFiyat = 9.50m },
    new { MalzemeAdi = "Kereviz", ToplamMiktar = 40, MalzemeBirim = "Kilogram", BirimFiyat = 7.50m }
};
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
